...
*/
/* To compile switchctl, use the appropriate cross compiler and run the
* command:
*
*  gcc -fno-tree-cselim -Wall -O0 -mcpu=arm9 -o switchctl switchctl.c \
*    switchctl-<model>.c
*
* switchctl-<model>.c is needed to provide read/write/init functions for
*   the MDIO/MDC lines
*
*/
